#![doc = "Peripheral access API for EFM32PG23B200F512IM40 microcontrollers (generated using svd2rust v0.33.4 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
pub struct Eusart2Ns {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for Eusart2Ns {}
impl Eusart2Ns {
    #[doc = r"Pointer to the register block"]
