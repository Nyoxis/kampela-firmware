...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pinneg(&mut self) -> PinnegW<Scan14Spec> {
        PinnegW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Negative Port Select"]
    #[inline(always)]
    #[must_use]
    pub fn portneg(&mut self) -> PortnegW<Scan14Spec> {
        PortnegW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Positive Pin Select"]
    #[inline(always)]
    #[must_use]
    pub fn pinpos(&mut self) -> PinposW<Scan14Spec> {
        PinposW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Positive Port Select"]
    #[inline(always)]
    #[must_use]
    pub fn portpos(&mut self) -> PortposW<Scan14Spec> {
        PortposW::new(self, 12)
    }
    #[doc = "Bit 16 - Configuration Group Select"]
    #[inline(always)]
    #[must_use]
    pub fn cfg(&mut self) -> CfgW<Scan14Spec> {
        CfgW::new(self, 16)
    }
    #[doc = "Bit 17 - Comparison Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp(&mut self) -> CmpW<Scan14Spec> {
        CmpW::new(self, 17)
    }
}
