...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pinneg(&mut self) -> PinnegW<Scan10Spec> {
        PinnegW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Negative Port Select"]
    #[inline(always)]
    #[must_use]
    pub fn portneg(&mut self) -> PortnegW<Scan10Spec> {
        PortnegW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Positive Pin Select"]
    #[inline(always)]
    #[must_use]
    pub fn pinpos(&mut self) -> PinposW<Scan10Spec> {
        PinposW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Positive Port Select"]
    #[inline(always)]
    #[must_use]
    pub fn portpos(&mut self) -> PortposW<Scan10Spec> {
        PortposW::new(self, 12)
    }
    #[doc = "Bit 16 - Configuration Group Select"]
    #[inline(always)]
    #[must_use]
    pub fn cfg(&mut self) -> CfgW<Scan10Spec> {
        CfgW::new(self, 16)
    }
    #[doc = "Bit 17 - Comparison Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp(&mut self) -> CmpW<Scan10Spec> {
        CmpW::new(self, 17)
    }
}
